declare const _default: {
    ...
    common: {
        ...
        spellChanceToHit: (playerLevel: number, targetLevel: number, spellHit: number, pvp?: boolean | undefined) => number;
        spellChanceToMiss: (playerLevel: number, targetLevel: number, spellHit: number, pvp?: boolean | undefined) => number;
        spellChanceToCrit: (playerLevel: number, targetLevel: number, spellHit: number, spellCrit: number, pvp?: boolean | undefined) => number;
        spellChanceToNormal: (playerLevel: number, targetLevel: number, spellHit: number, spellCrit: number, pvp?: boolean | undefined) => number;
        ...
        spellBaseChanceToHit: (playerLevel: number, targetLevel: number, pvp?: boolean | undefined) => number;
